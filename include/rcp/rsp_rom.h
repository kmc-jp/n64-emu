#ifndef N64_RCP_RSP_ROM_H
#define N64_RCP_RSP_ROM_H
...
// Hardware reciprocal / rsqrt approximation tables (RCP ROM).
inline constexpr uint16_t kRcpRom[512] = {
...
inline constexpr uint16_t kRsqRom[512] = {
